...
import com.example.renwuhulianwang.myapplication.util.AccessibilityHelper;
import com.example.renwuhulianwang.myapplication.util.NotifyHelper;
import com.example.renwuhulianwang.myapplication.util.SharedPreferencesUtil;
...
//            Toast.makeText(getContext(),"openHongBao",Toast.LENGTH_SHORT).show();
            openHongBao(event);
...
//        Toast.makeText(getContext(),"点中了红包",Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(getContext(),"拆红包1",Toast.LENGTH_SHORT).show();
                Log.w(TAG, "拆红包1");
                targetNode = AccessibilityHelper.findNodeInfosByText(nodeInfo, "拆红包");
            } else {
                Log.w(TAG, "拆红包2");
//                Toast.makeText(getContext(),"拆红包2",Toast.LENGTH_SHORT).show();
                String buttonId = "com.tencent.mm:id/brt";

                if(wechatVersion == 700) {
                    buttonId = "com.tencent.mm:id/brt";
                }
